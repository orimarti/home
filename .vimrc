...
" General {
	...
	command CDC cd %:p:h " Does not switch to the current file directory
                         " automatically, only if you type :CDC
    set backspace=indent,eol,start " make backspace a more flexible
    set backup " make backup files
    set backupdir=~/.vim/backup " where to put backup files
    set clipboard+=unnamed " share windows clipboard
    set diffopt=iwhite " options for vimdiff command: ignore white spaces
    ...
    set mouse= " do not use mouse anywhere
    set noerrorbells " don't make noise
    set whichwrap=b,s,h,l,<,>,~,[,] " everything raps
    "             | | | | | | | | |
    "             | | | | | | | | +-- "]" Insert and Replace
    "             | | | | | | | +-- "[" Insert and Replace
    "             | | | | | | +-- "~" Normal
...
"    "set shortmess=aOstT " shortens messages to avoid 
                         " 'press a key' prompt - this does not 
                         " show the message search hit BOTTOM, continuing at
                         " TOP
...
" Text Formatting/Layout {
    ...
    set tabstop=4 " tabs should be 4, and they will show with 
                   " set list on
" }
" Folding {
...
" Autocommands {
    ...
    " }
    " Puppet {
        " puppet standard 2 spaces, always
